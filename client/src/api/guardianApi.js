...
export const fetchGuardians = async () => {
    try {
        ...
        return response.data; // Handle the fetched guardians
    } catch (error) {
...
export const updateGuardian = async (id, guardianData) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to update guardian. Please try again later.',
        });
        throw error;
    }
};
...
export const deleteGuardian = async (id) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to delete guardian. Please try again later.',
        });
        throw error;
    }
};
