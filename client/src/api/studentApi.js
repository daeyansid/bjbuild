...
export const createStudent = async (studentData) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to create student. Please try again later.',
        });
        throw error;
    }
}
...
export const updateStudent = async (id, studentData) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to update student. Please try again later.',
        });
        throw error;
    }
};
...
export const deleteStudent = async (id) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to delete student. Please try again later.',
        });
        throw error;
    }
};
...
export const fetchGuardianByCnic = async (cnic) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to fetch guardian details. Please try again later.',
        });
        throw error;
    }
};
...
export const fetchStudentsByBatchYear = async (batchYear) => {
    try {
        ...
        console.error('Error fetching students by batch year:', error);
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to fetch students by batch year. Please try again later.',
        });
        throw error;
    }
};