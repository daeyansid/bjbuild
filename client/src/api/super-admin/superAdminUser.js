...
export const fetchBranchAdmins = async () => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to fetch branch admins. Please try again later.',
        });
        throw error;
    }
};
...
export const getBranchAdminById = async (id) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to fetch branch admin details. Please try again later.',
        });
...
export const deleteBranchAdmin = async (id) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to delete branch admin. Please try again later.',
        });
        throw error;
    }
};
...
export const updateBranchAdmin = async (id, branchAdminData) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to update branch admin. Please try again later.',
        });
        throw error;
    }
};
...
export const createBranchAdmin = async (branchAdminData) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to create branch admin. Please try again later.',
        });
        throw error;
    }
};
