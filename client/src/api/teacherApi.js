...
export const fetchTeacherById = async (id) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to fetch teacher details. Please try again later.',
        });
        throw error;
    }
};
...
export const createTeacher = async (teacherData) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to create teacher. Please try again later.',
        });
        throw error;
    }
};
...
export const deleteTeacher = async (id) => {
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Unable to delete teacher. Please try again later.',
        });
        throw error;
    }
};
