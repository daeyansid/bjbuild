...
import { adminName, adminEmail } from '../..';
            ...
            >
                <div className="h-full flex flex-col justify-between px-3 pb-4 overflow-y-auto bg-white">
                    <ul className="space-y-2 font-medium">
                                ...
                                <div className="flex flex-col items-start pl-6 md:pl-8">
                                    <ul>
                                        <li className="text-custom-blue rounded-lg group hover:bg-gray-300 cursor-pointer p-3">
                                            <Link to="/branch-admin/user-management/staff">Staff</Link>
                                        </li>
                                        <li className="text-custom-blue rounded-lg group hover:bg-gray-300 cursor-pointer p-3">
                        ...
                        <li>
                            <div
                                className="flex whitespace-nowrap items-center p-2 text-custom-blue rounded-lg group hover:bg-gray-100 cursor-no-drop"
                            >
                                <img src={clock} />
                        ...
                        <li>
                            ...
                            {isAttendanceManagementOpen && (
                                <div className="flex flex-col items-start pl-6 md:pl-8">
                                    <ul>
                                        <li className="text-custom-blue rounded-lg group hover:bg-gray-300 cursor-pointer p-3">Staff</li>
                                        <li className="text-custom-blue rounded-lg group hover:bg-gray-300 cursor-pointer p-3">Student</li>
                                    </ul>
                                </div>
                            )}
                        </li>
