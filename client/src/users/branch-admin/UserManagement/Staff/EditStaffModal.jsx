...
import { fetchStaffById, updateStaff } from '../../../../api/staffApi';
        ...
        const loadStaff = async () => {
            try {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'Unable to fetch staff data. Please try again later.',
                });
                setShowModal(false);
            }
        };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Unable to update staff details. Please try again later.',
            });
        }
    };
    ...
    return (
        ...
        >
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full max-h-full overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                <h2 className="text-2xl font-semibold text-indigo-900 mb-6">Update Staff Details</h2>
