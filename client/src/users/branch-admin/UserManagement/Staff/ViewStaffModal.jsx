        ...
        >
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full max-h-full overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-semibold text-indigo-900">Staff Details</h2>
                    <button
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="mb-4">
                        ...
                        <p className="text-gray-900">{staffData.salary || 'N/A'}</p>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <p className="text-gray-900">{staffData.employeeNumber || 'N/A'}</p>
                    </div>
