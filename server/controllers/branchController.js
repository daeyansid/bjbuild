...
exports.createBranch = async (req, res) => {
    const { branchName, branchType, branchAddress, assignedTo, branchPhoneNumber, branchEmailAddress, machineAttendance, dairy, startTime, endTime } = req.body;

    try {
        // Validate required fields
        const missingFields = validateRequiredFields({ branchName, branchType, branchAddress, assignedTo, branchPhoneNumber, machineAttendance, dairy, startTime, endTime });
...
exports.updateBranch = async (req, res) => {
    const { id } = req.params;
    const { branchName, branchType, branchAddress, assignedTo, branchPhoneNumber, branchEmailAddress, machineAttendance, dairy, startTime, endTime, branchAdminDetails } = req.body;
    ...
    try {
        ...
        branch.branchType = branchType !== undefined ? branchType : branch.branchType;
